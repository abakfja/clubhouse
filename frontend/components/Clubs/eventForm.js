						...
						<div className="">
							...
							<div className="flex my-3 w-full justify-between items-center">
								<input
									...
									className=" w-2/5 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
									type="time"
									placeholder="Some Name"
								/>
								<span> {"-->"} </span>
								<input
									...
									className=" w-2/5 ml-3 text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
									type="time"
									placeholder="Some Name"
								/>
							</div>
